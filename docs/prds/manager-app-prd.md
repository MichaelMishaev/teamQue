...
| MGR-FIELD-013 | The default Independence Square field is permanent and cannot be closed or expired: ending its evening records an active/paused match as finished, clears unplayed queue entries, retains the same active slug, and appends an evening-ended activity entry. |
