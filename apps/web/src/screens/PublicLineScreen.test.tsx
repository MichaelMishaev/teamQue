...
describe('PublicLineScreen', () => {
  ...
  it('is operationally read-only and replaces the snapshot from realtime updates', async () => {
    ...
    const whatsappLogo = screen.getByTestId('public-line-whatsapp-logo')
    expect(whatsappLogo.getAttribute('aria-hidden')).toBe('true')
    expect(whatsappLogo.getAttribute('fill')).toBe('currentColor')
